...
First, use [Shortcut](images/tutorial/keyboard_shortcut.png) to access the Dev Settings. The Safe Mode Toggle will appear at the top of the calculator.

Then, simply toggle Safe Mode on or off as you desire. Invalid inputs are locked when Safe Mode is on [Locked](images/lock_icon.png) and can be changed when Safe Mode is off. [Unlocked](images/tutorial/unlock_icon.png)
